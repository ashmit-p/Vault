  ...
  const formSchema=authFormSchema(type);
    ...
    const form = useForm<z.infer<typeof formSchema>>({
      ...
      const onSubmit = async (values: z.infer<typeof formSchema>) => {
        ...
        try{
          const user =
          type === "sign-up" ? await createAccount({ fullName: values.fullName || "", email: values.email  }) : await signInUser({ email: values.email });
            ...
            <h1 className="form-title">
             ...
             {type === "sign-up" && <FormField
              ...
              <div className="body-2 flex justify-center">
                ...
                <Link href={type === "sign-in"? "/sign-up":"/sign-in"} className="ml-1 font-medium text-[#8fd5d7]">
                {" "}
